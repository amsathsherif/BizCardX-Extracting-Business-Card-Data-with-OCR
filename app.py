...
with st.sidebar:
  select= option_menu("Main Menu", ["Home","Upload & Modifing", "Delete"])
if select=="Home":
  pass
elif select=="Upload & Modifing":
  img=st.file_uploader("Upload the images", type=["png","jpg","jpeg"])
